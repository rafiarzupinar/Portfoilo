...
const ContactForm = () => {
  return (
    <form>
      ...
      <button className='px-6 py-3 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-500 hover:bg-blue-400'>Send Message</button>
    </form>
  )
}
